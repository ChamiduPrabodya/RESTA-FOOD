...
function AuthHeaderActions() {
  ...
  const { authUser, logout, purchases, vipBookings } = useAuth();
  ...
  return (
    <>
      <Stack direction="row" spacing={1.5} alignItems="center">
        <Button sx={{ minWidth: 38, width: 38, height: 38, p: 0, color: "text.secondary", border: "1px solid rgba(212,178,95,0.2)", borderRadius: 99 }}>
